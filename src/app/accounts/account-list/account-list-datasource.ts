...
export class AccountListDataSource extends DataSource<Account> {
  ...
  constructor(public accountData: Account[]) {
    super();
  ...
  private getSortedData(data: Account[]): Account[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        case 'number': return compare(a.account_number, b.account_number, isAsc);
        case 'type': return compare(+a.account_type, +b.account_type, isAsc);
